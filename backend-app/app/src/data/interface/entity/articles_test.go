...
var (
	articleDBTypes = map[string]string{`ID`: `integer`, `IsDeleted`: `boolean`, `Owner`: `character varying`, `ContributorUID`: `character varying`, `ContributorAccount`: `character varying`, `Body`: `text`, `CreatedAt`: `timestamp without time zone`, `ModifiedAt`: `timestamp without time zone`}
	_              = bytes.MinRead
)
