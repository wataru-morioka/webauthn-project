...
var (
	commentDBTypes = map[string]string{`ID`: `integer`, `IsDeleted`: `boolean`, `ContributorUID`: `character varying`, `ContributorAccount`: `character varying`, `Body`: `text`, `CreatedAt`: `timestamp without time zone`, `ModifiedAt`: `timestamp without time zone`, `ArticleID`: `integer`}
	_              = bytes.MinRead
)
