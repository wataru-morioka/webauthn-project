...
var (
	contactDBTypes = map[string]string{`ID`: `integer`, `Account`: `character varying`, `CreatedDatetime`: `timestamp without time zone`, `Email`: `character varying`, `Message`: `character varying`, `Name`: `character varying`, `Organization`: `character varying`, `Phone`: `character varying`, `State`: `character varying`, `UID`: `character varying`}
	_              = bytes.MinRead
)
